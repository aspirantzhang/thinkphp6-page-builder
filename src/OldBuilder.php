...
class OldBuilder
{
    ...
    public function __call($name, $arguments)
    {
        if ($this->isToContainer($name)) {
            ...
            return $this;
        } elseif ($this->isCommonContainer($name)) {
            $this->containerName = $name;

            return $this;
        } elseif ($this->isAddElement($name)) {
            ...
            if ($this->isCommonElement($name)) {
                ...
                if (false !== $this->haveData($arguments[0])) {
                    if (true == $writeValue) {
                    ...
                    if ('tree' == $componentName) {
                        ...
                        } elseif (is_string($this->haveData($arguments[0])) && (false !== strpos($this->haveData($arguments[0]), ','))) {
    ...
    {
        return (0 === strpos($name, 'to')) && preg_match('/^[A-Z]+$/', substr($name, 2, 1));
    }
    ...
    {
        return (0 === strpos($name, 'add')) && preg_match('/^[A-Z]+$/', substr($name, 3, 1));
    }
